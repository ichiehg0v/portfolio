...
export const ui = {
  zh: {
    ...
    'about.name': '陳以婕',
    'about.bio1': '正在與 AI co-work 完成專案的程式麻瓜，本頁面使用 Windsurf 與 Cursor 編寫，花費時間 3 小時。',
  ...
  en: {
    ...
    'about.bio1': 'A non-developer working with AI to complete projects. This page was created with Windsurf and Cursor in 3 hours.',
